...
//   <div className='data-class01'>
//     <h1>Course 01</h1>

//     <img src={demo01} alt="Course Image" className='course-image' />
//     <div className='data-class-content'>
//      djopkasdhashpd
//     </div>
...
//   </div>      <div className='data-class01'>
//     <h1>Course 01</h1>
