        ...
        <div className="data02-class01">
          ...
          <div>
            ...
            <div>
              ...
              <div
                className="data02-class01-list-item"
                style={{ height: "250px" }}
              >
                <h1 style={{ fontSize: "35px", marginLeft: "10px" }}>
                  Featured Review
                </h1>
                <div>
                  <h3
                  ...
                  >
                    ...
                    fugiat dolor hic placeat, recusandae voluptatibus eveniet
                    exercitationem similique corporis deserunt culpa dolorem
                    libero consectetur mollitia reiciendis ipsam, ratione rerum
                    illo.
                    <br />
                  </h3>
                  <h3
                ...
                <div style={{ marginTop: "90px", marginLeft: "-60px" }}>
                  <h1 style={{ fontSize: "50px" }}>Student also bought</h1>
                  <div className="data02-class01-list-item"></div>
                  <div className="data02-class01-list-item"></div>
                  <div className="data02-class01-list-item"></div>
                  <div className="data02-class01-list-item"></div>
